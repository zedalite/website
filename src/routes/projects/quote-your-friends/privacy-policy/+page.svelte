...
<div class="container mx-auto flex flex-col gap-8 p-8">
    <a href="/projects/quote-your-friends" class="btn variant-ghost">
    ...
    <div>
        ...
        <p>
        Zedalite built the QuoteYourFriends app as a Free app. This SERVICE is provided by Zedalite at no cost and is intended
        for use as is.
        </p>
        <p>
        ...
        QuoteYourFriends unless otherwise defined in this Privacy Policy.
        </p>
        ...
        information, including but not limited to e-mail, login-data, ip-address. The information that I request will be
        ...
        <p>
        I want to inform users of this Service that these third parties have access to their Personal Information. The reason
        ...
        <p>This policy is effective as of 2024-01-10</p>
