...
<div class="container mx-auto flex flex-col gap-8 p-8">
  ...
  <div>
    ...
    <p>
      Zedalite built the QuoteYourFriends app as a Free app. This SERVICE is provided by Zedalite at no cost and is
    ...
    <p>
      ...
      at QuoteYourFriends unless otherwise defined in this Privacy Policy.
    </p>
    <p><strong>Information Collection and Use</strong></p>
    <p>
      For a better experience, while using our Service, I may require you to provide us with certain personally
      identifiable information, including but not limited to e-mail, login-data, ip-address. The information that I
